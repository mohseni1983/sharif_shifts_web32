...
class _MadadjousEditState extends State<MadadjousEdit> {
  ...
  Future<bool> saveHamiInfo(MadadjouSingle madadjou) async {
    ...
    try {
      result = await http
          .post(globalVars.s_url + 'api/Madadkar/AddMadadjouToHami',
  ...
  Future<bool> removeMadadjou(HamiMadadjouSet madadjouSet) async{
    var _body=hamiMadadjouSetToJson(madadjouSet);
    try{
      var result=await http.post(globalVars.s_url+'api/Madadkar/RemoveMadadjouToHami',
  ...
  void initState() {
    ...
    setState(() {
      ...
      widget.hami.hamiMadadjouSet.forEach((element) {
        MadadjouSingle single = new MadadjouSingle(
            hamiId: element.hamiId,
            madadjouId: element.madadjouId,
            madadjouLname: element.madadjouLname,
            madadjouFname: element.madadjouFname);
                                          ...
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: <Widget>[
                                                new Container(
                                                  child: new Text(
                                                    '${s[index].madadjuFName} ${s[index].madadjuLName}',
                                                    textScaleFactor: 1.2,
                                                  ),
                                                ),
                                                IconButton(
                                      ...
                                      itemBuilder: (context, index) {
                                        return Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                  '${addedMadadjous[index].madadjouFname} ${addedMadadjous[index].madadjouLname}'),
                                              IconButton(
                                                  icon: Icon(
                                                    Icons.remove_circle,
                                                    color: Colors.red,
                          ...
                          FlatButton(
                              onPressed: () {
                                ...
                                widget.hami.hamiMadadjouSet.forEach((element) {
                                  ...
                                  if (_found == false)
                                  removeMadadjou(element).then((value) {
                                    if (value)
                                      debugPrint('removed');
                                    else
                                ...
                                _showDialog('پایان عملیات', 'ذخیره سازی انجام شد');
                              },
  ...
  void _addToHamiMadadjous(Madadjous madadjous) {
    bool _exist = false;
    addedMadadjous.forEach((element) {
      if (element.madadjouId == madadjous.madadjuId) _exist = true;
    });
    if (_exist == false) {
